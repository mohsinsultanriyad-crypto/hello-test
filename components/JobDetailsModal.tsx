...
import { X, Phone, Mail, MapPin, ShieldCheck, Share2, MessageCircle, Zap, Bookmark } from 'lucide-react';
...
const JobDetailsModal: React.FC<JobDetailsModalProps> = ({ job, onClose }) => {
  ...
  const whatsappUrl = `https://wa.me/${job.phoneNumber.replace(/\D/g, '')}?text=${encodeURIComponent(`Hello, I am interested in the ${job.jobRole} position in ${job.city} that I saw on Saudi Job.`)}`;
